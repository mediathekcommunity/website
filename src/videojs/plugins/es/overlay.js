...
!((e) => {
	...
	"undefined" != typeof window && window.videojs
		...
		: "function" == typeof define && define.amd
			? define("vroll", ["video.js"], (t) => e(t.default || t))
	...
	(
		(t = t && Object.hasOwn(t, "default") ? t.default : t).registerPlugin ||
		t.plugin
	)("overlay", function (f, t) {
		this.ready(function () {
			{
				var p = this,
					n = f,
							...
							for (let t = 0; t < n.length; t++) {
								...
								if ((o.start || (o.start = 0), o.duration))
									if (parseInt(o.start + o.duration) <= e && o.used) {
										const e = p.el_.querySelector("#" + o.id);
										e &&
											((e.style.opacity = 0),
											setTimeout(() => {
												try {
				...
				const r = (l) => {
					...
					if (
						...
						if (!p.options_.multiOverlay) {
							const e = p.el_.querySelectorAll(".vjs-ov");
							if (e)
						...
						t.className =
							"vjs-mute-control vjs-control vjs-button mute-overlay vjs-vol-3";
					...
					if (
						...
						let t = "0",
							e =
								(l.offsetX &&
									(t = c(l.offsetX) ? l.offsetX : parseInt(l.offsetX) + "px"),
								l.offsetY &&
									(c(l.offsetY)
						...
						let t = "0",
							e =
								(l.offsetX &&
									(t = c(l.offsetX) ? offsetX : parseInt(l.offsetX) + "px"),
								l.offsetY &&
									(c(l.offsetY)
										? (a.style.top = l.offsetY)
										: (a.style.top = parseInt(l.offsetY) + "px")),
						...
						let t = "0",
							e =
								(l.offsetY &&
									(c(l.offsetY) && (t = l.offsetY),
									(t = parseInt(l.offsetY) + "px")),
								!0);
						(e = l.slide ? l.slide : e)
							? ((a.style.top = "-100%"),
								setTimeout(() => {
					...
					if (!a()) {
						...
						if (o)
							for (let t = 0; t < o.length; t++) {
								...
								("img" != i && "video" != i) ||
									(o[t].parentNode.removeChild(o[t]), (d = !1)),
									"text" == i &&
										e[0].txt &&
										!p.options_.multiOverlay &&
										(e[0].position || (e[0].position = "top-left"),
										s == e[0].position) &&
										((o[t].style.opacity = 0), setTimeout(() => {}, 800));
							}
						for (let t = 0; t < e.length; t++)
