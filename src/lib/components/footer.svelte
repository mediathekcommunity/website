<script>
    // No changes needed in the script section for this task
</script>
    ...
    <div class="footer-content">
        <div class="footer-left">
            ...
            <div class="tmdb-logo">
                ...
                >
                    ...
                    <g id="base-layer" data-name="Layer 2">
                        <g id="main-layer" data-name="Layer 1">
                            <path
                                class="logo-path"
        ...
        <nav class="footer-right">
            <span>
                ...
                <a target="_blank" href="https://daisyui.com">DaisyUI v5 beta</a>
            </span>
