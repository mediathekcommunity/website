...
const defaults = {
		...
		src: '',
		responsive: !1,
		mediaqueries: { tiny: 0.5, small: 0.75, medium: 1, large: 1.25, xlarge: 1.5 }
	},
	onPlayerReady = (e, t) => {
		defaults.basePath = '';
		...
		function p(e) {
			var t, i, s;
			if (-1 === (i = e.indexOf('#'))) return { src: e, w: 0, h: 0, x: 0, y: 0 };
			t = e.substring(0, i);
		...
		e.on('medialoaded', function (t, s) {
			...
			(l = e.el_.querySelector('.vjs-progress-holder')).removeEventListener('touchstart', _);
		...
		function b() {
			...
			var f = d.el_.querySelector('.vjs-play-progress').querySelector('.vjs-time-tooltip');
		...
		u = function (t) {
			...
			else if (t.changedTouches) v = t.changedTouches[0].pageX || t.touches[0].clientX;
			var f = v - c.left;
